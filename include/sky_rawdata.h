...
#ifdef FEATURE_SKY_ABNORMAL_POWER_INFO			 //p13156@lks ps1_20110520
#define ABNORMAL_POWER_INFO_START			(PANTECH_ROOTING_CHECK_START+PANTECH_ROOTING_CHECK_LENGTH)
#define ABNORMAL_POWER_INFO_START_LENGTH		(SECTOR_SIZE*SECTOR_SIZE_DEFAULT)
#endif

#ifdef FEATURE_PANTECH_AUTO_REPAIR
#ifdef FEATURE_SKY_ABNORMAL_POWER_INFO			 //p13156@lks ps1_20110520
#define PANTECH_REPAIR_USERDATA_START         (ABNORMAL_POWER_INFO_START+ABNORMAL_POWER_INFO_START_LENGTH)
...
#endif
#else
#ifdef FEATURE_SKY_ABNORMAL_POWER_INFO	
#define BACKUP_SECTOR_LENGTH		      (ABNORMAL_POWER_INFO_START+ABNORMAL_POWER_INFO_START_LENGTH-BACKUP_SECTOR_START)
#else
...
#ifdef FEATURE_SKY_ABNORMAL_POWER_INFO
extern int sky_sys_ResetAbnormPwrInfo(int force);
extern int sky_sys_GetAbnormPwrInfo(unsigned int *pwr_on_info);
extern int sky_sys_SetPwrOnCnt(void);  
extern int sky_sys_SetPwrOffCnt(void);
#endif
